...
const ContactMeProbando = () => {
  ...
  const pageOverflowHidden = overlay ? 'overflow: hidden' : ''

  return (
    <div className={overlay ? styles.overlay : styles.wrapper} onClick={overlayModal}>
      <div className={`${styles.modal} ${googleSans.className}`} onClick={modalDontClose}>
        ...
        <form className={styles.form} onSubmit={handleSubmit} style={minimize ? { display: 'none' } : null}>
          ...
          <section className={styles.body}>
            ...
            <div className={styles.message}>
              <textarea name='Message' value={data.message} onChange={(e) => onChange(e, 'message')} className={`${googleSans.variable} ${roboto.variable}`} />
            </div>
          </section>
